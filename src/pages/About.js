    ...
    <div className="About">
      <div className="about-components">
        ...
        <p className="about-quote">
          Explore The Sweet Blooms Kitchen today & let your taste buds bloom
          with delight
        </p>
      </div>
      <div className="about-bodyy">
        ...
        <p className="abouts-description">
          Welcome to The Sweet Blooms Kitchen, where every delicious bite is a
          blossoming journey of love and flavour. Our charming online dessert
          shop, based in the of Tripoli, is led by a dedicated mom with a
          passion for creating the most delectable home made petites fours in
          town.
        </p>
      </div>
    </div>
